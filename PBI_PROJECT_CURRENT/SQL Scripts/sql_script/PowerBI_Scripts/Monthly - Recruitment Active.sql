...
SELECT P.[Policy No]
	  ...
	  ,IIF(MONTH(a.[Date_Appointed]) = MONTH(P.[Collected Date]) AND (YEAR(a.[Date_Appointed]) = YEAR(P.[Collected Date]) ),1,0) AS Check3
...
SELECT  COUNT( DISTINCT Temp2.[Issuing Agent]) AS Recruitment_Active
,Temp2.YearCo, Temp2.MonthCo
...
,Temp2.YearCo
--	,Agent.Check3
ORDER BY Temp2.YearCo desc, Temp2.MonthCo
