...
/****** Object:  View [DPO].[Target_AD]    Script Date: 1/17/2022 11:27:44 AM ******/
SET ANSI_NULLS ON
GO
...
SELECT [AD Code], [AD Name], unpvt.[Grade], YearTarget, MonthTarget, TargetFYP, LS.[Last_Status],LS.[Last_Status_Date],LS.[Appointed_Date]
      ,LS.[Terminated_Date]
