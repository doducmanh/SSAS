...
/****** Object:  View [DPO].[AD_Appointed_Date]    Script Date: 7/26/2021 9:24:20 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [DPO].[AD_Appointed_Date]
AS
WITH Q AS (SELECT AD_Code, MAX(ID) AS Last_ID
